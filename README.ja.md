...
[最新版をダウンロード](https://github.com/wishworldbetter/claude-codex-desktop/releases/latest)

## インストール

[Releases](https://github.com/wishworldbetter/claude-codex-desktop/releases) ページから最新の DMG ファイルをダウンロードし、インストールしてください。
